...
ASCII “0”s and “1”s and your code prints an equivalent decimal string
    ...
    If the first byte number is 1, which means the number is negative, I will add '-' in the output. 
